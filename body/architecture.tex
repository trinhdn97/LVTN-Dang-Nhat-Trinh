...
\textbf{Swagger} là một phần mềm mã nguồn mở, chuyên dùng để thiết kế, xây dựng, sử dụng và làm tài liệu cho các ứng dụng web RESTful. Chúng tôi sử dụng thư viện Swagger UI Express\footnote{\href{https://www.npmjs.com/package/swagger-ui-express}{https://www.npmjs.com/package/swagger-ui-express}} trên khung thức Node.js để làm tài liệu cho các \acrshort{api} ở backend và gọi thử các \acrshort{api} đó, hỗ trợ quá trình hiện thực \acrshort{ui} của ứng dụng.\par
...
\end{enumerate}
\subsubsection{Giao diện lập trình ứng dụng}
...
\begin{enumerate}
    ...
    \end{itemize}
    \item Thanh điều hướng (Sidebar) gồm tên ứng dụng webfuzzer, hai mục Dashboard và Result để điều hướng tới hai trang web chính của ứng dụng, kèm theo đường dẫn đến thư mục mã nguồn ứng dụng trên gitlab\footnote{\href{https://gitlab.com/y4t0g4m1/webfuzzer-nodejs}{https://gitlab.com/y4t0g4m1/webfuzzer-nodejs}}.
\end{enumerate}
